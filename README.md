...
The graph structures and effects are sourced from BnRep repository under MIT Liscence. We manually collected other semantic information, such as variable descriptions, and quantitative information, such as variable ranges. To know concrete input that framework uses for creating prompts, please check DAG yaml files. 
